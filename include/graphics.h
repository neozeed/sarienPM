 ...
 *  
 *  $Id: graphics.h,v 1.16 2002/09/07 18:32:37 cmatsuoka Exp $
 *
...
struct gfx_driver {
	...
	void	(*put_pixels)(int x, int y, int w, pixel_t *p);
...
void	put_pixels_a	(int, int, int, pixel_t *);
...
void	save_block	(int, int, int, int, pixel_t *);
void	restore_block	(int, int, int, int, pixel_t *);
